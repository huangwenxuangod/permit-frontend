...
## 1. 通用说明
- Base URL：`https://huangwenxuangod.xyz`
- Header：
...
- 响应：
```json
{"taskId":"...","urls":{"white":"...","blue":"..."},"receiptUrls":{"receipt":"..."},"layoutUrls":{"6inch":"..."},"expiresIn":600}
```
...
- 请求：
```json
{"taskId":"...","items":[{"type":"receipt","qty":1}],"city":"上海","remark":"测试","amountCents":990,"channel":"wechat"}
```
- 响应：Order
